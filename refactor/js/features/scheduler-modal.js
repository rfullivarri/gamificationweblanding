/**
 * Módulo: scheduler-modal
 * Propósito: definir el web component <scheduler-modal> usado para programar la Daily Quest.
 * API pública: eventos custom (open, schedule:save, schedule:pause, schedule:resume, schedule:test), métodos setValue/setNotice/open/close.
 * Dependencias: Web Components nativos y estilos inyectados en el shadow.
 */
